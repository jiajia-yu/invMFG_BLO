function [rho,mx,my,outs] = solve_mfg_fista(rho0,rho1,b,lambdaF,lambdaG,opts)
%% parameters
...
for nit = 1:maxit
    % backtracking
    [objy,gradyrho,gradymx,gradymy] = comp_valgradL(siz,yrho,ymx,ymy,rho0,rho1,b,lambdaF,lambdaG);
    subnit = 1;
%     stepsize = stepsize0;
    while subnit < submaxit
        ...
        obj_nit = comp_valL(siz,xrho_nit,xmx_nit,xmy_nit,rho0,rho1,b,lambdaF,lambdaG);
